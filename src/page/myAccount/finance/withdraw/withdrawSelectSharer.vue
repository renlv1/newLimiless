        ...
        <li v-for="(item, index) in sharerList" :key="index" :class="{'active': liActive === index}" @click="doSelectSharer(index)">
          ...
          <div class="info">
            <div class="info-top">
              ...
              <div class="bottom">
                <div class="charge">
                  <span>手续费：</span><i>0.6%</i>
                </div>
                <div class="credit">
                  <span>信用</span>
                  <ul>
                    <li v-for="(item2, index2) in starList" :key="index2" :class="{'yellow': item.credit > index2}">
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div class="info-bottom">
              <p>
                <span>交易金额：</span><i>50000.0000USD</i>
              </p>
              <p>
...
export default {
  ...
  methods: {
    doSelectSharer (index) {
      console.log(index, this.liActive)
